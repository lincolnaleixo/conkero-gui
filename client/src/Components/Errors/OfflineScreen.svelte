...
<svelte:head>
  <title>Offline | Conkero - Svelte Admin & Dashboard Template</title>
</svelte:head>
<div
          ...
          <Card class="card overflow-hidden">
            <CardBody class="p-4">
              <div class="text-center">
                <img
                  src="https://img.themesbrand.com/Conkero/images/auth-offline.gif"
                  alt=""
                  height="210"
                />
                <h3 class="mt-4 fw-semibold">We're currently offline</h3>
                <p class="text-muted mb-4 fs-14">
                  We can't show you this images because you aren't connected to
                  the internet. When you’re back online refresh the page or hit
                  the button below
                </p>
